...
beaches = [
  ...
  { user: user, name: 'Neptune', location: 'Europe', description: 'Amazing place', price: '', photo: Rails.root.join("app/assets/images/beach_7.jpeg").open },
  { user: user, name: 'Atlantis', location: 'Europe', description: '5-star treatment', price: '', photo: Rails.root.join("app/assets/images/beach_8.jpeg").open },
  { user: user, name: 'Seila', location: 'Asia', description: 'Beautiful beach', price: 150, photo: Rails.root.join("app/assets/images/beach_9.jpeg").open },
  ...
  { user: user, name: 'Love island', location: 'Australia', description: '', price: 800, photo: Rails.root.join("app/assets/images/beach_12.jpeg").open },
